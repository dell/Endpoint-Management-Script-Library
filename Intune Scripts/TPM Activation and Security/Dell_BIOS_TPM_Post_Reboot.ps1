...
Function Activate-DellBIOSTPM
{
		...
		try{
			...
			#Activate TPM
			Set-DellBIOSAttribute -AttributeName "TpmActivation" -AttributeValueName "Enabled" -AdminPwd $AdminPwd -EA stop
		...
		{
			Write-Host $result
			Write-Host "Function Activate-DellBIOSTPM Executed"	
		}
}
