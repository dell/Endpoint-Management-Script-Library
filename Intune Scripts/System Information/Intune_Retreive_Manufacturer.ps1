...
<#
.Synopsis
   This PowerShell script retrieves the manufacturer of the system.
...
.DESCRIPTION
   This Powershell script uses WMI call to retrieve the manufacturer information in JSON format.
.EXAMPLE
	An example of the manufacturer info retrived in JSON format:
	{"Manufacturer":"Dell Inc."}
#>

$Manufacturer= Get-CimInstance -Namespace root\dcim\sysman -ClassName DCIM_Chassis | Select -ExpandProperty Manufacturer
